...
class DDIN2(BaseModel):
    ...
    def __init__(self, dnn_feature_columns, target_feature_list, pv_history_fc_names=None, pv_item_id_history_fc_names=None
        ...
        super(DDIN2, self).__init__([], dnn_feature_columns, l2_reg_linear=0.0, l2_reg_embedding=l2_reg_embedding,
    ...
    def forward(self, X):
        ...
        combined_pv_seq_emb = torch.cat([pv_keys_emb, pv_item_id_emb, pv_release_year_emb, pv_class_emb], dim=-1)
        combined_click_seq_emb = torch.cat([click_keys_emb, click_item_id_emb, click_release_year_emb, click_class_emb], dim=-1)
